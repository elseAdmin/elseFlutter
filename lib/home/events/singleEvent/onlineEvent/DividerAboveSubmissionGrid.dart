...
class DividerAboveSubmissionGrid extends StatefulWidget {
  ...
  @override
  DividerAboveSubmissionGridState createState() =>
      DividerAboveSubmissionGridState();
}

class DividerAboveSubmissionGridState
    extends State<DividerAboveSubmissionGrid> {
  @override
