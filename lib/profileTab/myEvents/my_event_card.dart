...
class MyEventCard extends StatelessWidget {
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[Text("Participated"), Text(displayDate)],
                )),
            Container(
                padding: EdgeInsets.only(
                    bottom: SizeConfig.blockSizeHorizontal,
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                        onTap: () =>
                            _redirectToSingleEventPage(context, eventDetails),
                        child: Text(
                          "more details",
  ...
  String getDisplayDateForParticipatedAt(EventModel eventDetails) {
    ...
    if (eventDetails.type.compareTo('Online') == 0) {
      OnlineEventSubmissionModel submissionDetail =
          details['submissionDetails'];
      participatedAt = submissionDetail.participatedAt;
      displayDate = participatedAt.day.toString() +
          " " +
          HelperMethods()
              .getMonthNameForMonth(participatedAt.month.toString()) +
          " " +
          participatedAt.year.toString();
    }
    if (eventDetails.type.compareTo('Offline') == 0) {
      OfflineEventSubmissionModel submissionDetail =
          details['submissionDetails'];
      participatedAt = submissionDetail.participatedAt;
      displayDate = participatedAt.day.toString() +
          " " +
    ...
    if (eventDetails.type.compareTo('Location') == 0) {
      LocationEventSubmissionModel submissionDetail =
          details['submissionDetails'];
      participatedAt = submissionDetail.participatedAt;
      displayDate = participatedAt.day.toString() +
          " " +
